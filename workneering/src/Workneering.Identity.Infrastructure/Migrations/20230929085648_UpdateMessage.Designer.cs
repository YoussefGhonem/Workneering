...
namespace Workneering.Identity.Infrastructure.Migrations
{
    ...
    [Migration("20230929085648_UpdateMessage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Workneering.Identity.Domain.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Messages", "IdentitySchema");
                });
            ...
            modelBuilder.Entity("Workneering.Identity.Domain.Entities.Message", b =>
                {
                    b.HasOne("Workneering.Identity.Domain.Entities.User", "Recipient")
                        .WithMany("MessagesReceived")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Workneering.Identity.Domain.Entities.User", "Sender")
