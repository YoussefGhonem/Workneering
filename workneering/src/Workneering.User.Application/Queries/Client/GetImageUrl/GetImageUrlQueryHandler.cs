...
namespace Workneering.User.Application.Queries.Client.GetImageUrl
{
    public class GetImageUrlQueryHandler : IRequestHandler<GetImageUrlQuery, GetImageUrlDto>
    {
        ...
        public GetImageUrlQueryHandler(UserDatabaseContext userDatabaseContext, IDbQueryService dbQueryService, IStorageService storageService)
        {
